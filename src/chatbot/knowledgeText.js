export const knowledgeText = `# Vishal Kodam — Knowledge Base (Portfolio)
...
- Link: https://ieeexplore.ieee.org/abstract/document/9781958

## What I do (Skills)
### Data Analysis
Skilled in extracting valuable insights from complex datasets, leveraging statistical methods and machine learning techniques to inform decision-making.

### LLM Mastery
Developed tools using advanced language models like OpenAI’s GPT, integrating AI for efficient document indexing and query analysis.

### Machine Learning
Experienced in applying neural networks and advanced algorithms to solve complex problems across various domains, with a focus on practical, data-driven solutions.

### DevOps
Hands-on experience with cloud services and automation, including AWS and RESTful services, enhancing workflow efficiency and reducing errors.

## Projects (selected)
Each project includes a short description, tech stack, and GitHub link.

### JIRA AI Assistant - Conversational AI for Streamlined Task Management
...
### COVID-19 Detection through Alexa
...
## Links / Social
- LinkedIn: https://www.linkedin.com/in/vishal-kodam/
- GitHub: https://github.com/vishalkodam
- Instagram: https://www.instagram.com/__vishal017
- LeetCode: https://leetcode.com/u/Vishal_kodam/

## Contact
- Preferred: Use the contact form on this website for collaborations/work opportunities.
`;
